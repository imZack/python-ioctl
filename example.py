...
I don't recommend using this example on any important data. Both btrfs and the
ioctl module are highly experimental!
"""
...
# this should perform a "copy on write" operation which makes the destination
# file a clone of the source (sharing same blocks on disk)
